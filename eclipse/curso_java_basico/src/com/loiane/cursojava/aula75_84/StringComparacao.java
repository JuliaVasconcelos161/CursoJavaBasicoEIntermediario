...
public class StringComparacao {
	...
	public static void main(String[] args) {
		...
		System.out.println("ola == ola2 " + (ola == ola3)); //true
		...
		System.out.println(banana.regionMatches(1, ana, 1, 2));//false, pois comeca a avaliar apartir do carter de index 1
		System.out.println(banana.regionMatches(true, 0, ban, 0, 3));//true // com adicao do equalsIgnoreCase
