...
public class DatasNoJava8 {
	...
	public static void main(String[] args) {
		...
		System.out.println(LocalDate.of(2020, 2, 1));
		...
		System.out.println(LocalDateTime.of(2019,  2, 10, 20, 35, 10));
		System.out.println(LocalDateTime.parse("2019-02-10T20:35:10"));
...
//		}
		...
		ZonedDateTime zdt = ZonedDateTime.of(LocalDateTime.parse("2019-02-10T20:35:10"), sp);
		System.out.println(zdt);
		System.out.println(ZonedDateTime.parse("2019-02-10T20:35:10-02:00[America/Sao_Paulo]"));
